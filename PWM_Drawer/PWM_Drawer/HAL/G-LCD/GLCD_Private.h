...
#define GLCD_PRIVATE_H_
	...
	/* GLCD Register Select */
	#define GLCD_IR				DIO_PIN_LOW
	#define GLCD_DR				DIO_PIN_HIGH
	
	/* GLCD Read / Write Mode */
	#define GLCD_WRITE_MODE		DIO_PIN_LOW
	#define GLCD_READ_MODE		DIO_PIN_HIGH
	
	/* GLCD Page Select */
	#define GLCD_NO_PAGE_SELECTED	0
	#define GLCD_PAGE_0				1
	#define GLCD_PAGE_1				2
	#define GLCD_BOTH_PAGES			3
	
	/* Timer Used for Delay in ms*/
	/*
	GLCD_TIMER0_DLEAY_MS
	GLCD_TIMER2_DLEAY_MS
	*/
	#define GLCD_TIMER0_DLEAY_MS	0
	#define GLCD_TIMER2_DLEAY_MS	2
